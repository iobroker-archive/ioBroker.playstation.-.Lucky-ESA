module.exports = {
    ...
    async createStore() {
        ...
        common = {
            name: {
                ...
                ru: "Магазин Playstation",
                pt: "Loja de Playstation",
                nl: "Playstation store",
                fr: "Magasin Playstation",
                it: "Playstation store",
                es: "Playstation store",
                pl: "Sklep Playstation",
                uk: "Магазин ігрових станцій",
                "zh-cn": "游戏站商店",
            },
            desc: "Playstation store",
            icon: "img/store.png",
        };
        await this.createDataPoint(`profile_remote_store`, common, "channel", null, null);
        common = {
            type: "string",
            role: "state",
            name: {
        ...
        await this.createDataPoint(`profile_remote_store.result`, common, "state", "", null);
        common = {
            type: "number",
            role: "value",
            name: {
        ...
        await this.createDataPoint(`profile_remote_store.total`, common, "state", 0, null);
        common = {
            type: "string",
            role: "state",
            name: {
                ...
                ru: "Категория поиска",
                pt: "Categoria de pesquisa",
                nl: "Zoekcategorie",
                fr: "Catégorie de recherche",
                it: "Ricerca categoria",
                es: "Categoría de búsqueda",
                pl: "Kategoria wyszukiwania",
                uk: "Пошук категорії",
                "zh-cn": "搜索类别",
            },
            ...
            read: true,
            write: true,
            def: "44d8bb20-653e-431e-8ad0-c0a365f68d2f",
            states: {
                "44d8bb20-653e-431e-8ad0-c0a365f68d2f": "PS4_GAMES",
                "4cbf39e2-5749-4970-ba81-93a489e4570c": "PS5_GAMES",
                "038b4df3-bb4c-48f8-8290-3feb35f0f0fd": "PS_PLUS",
                "803cee19-e5a1-4d59-a463-0b6b2701bf7c": "SALES",
                "74d4e266-5c64-4c61-a7e3-1b6e78f643e6": "EA_GAMES",
                "2ff6eb11-f271-4803-9f79-5b28586f116e": "EA_PLAY_EARLY_ACCESS",
                "95239ca7-2dcf-43d9-8d4b-b7672ee9304a": "VR",
                "62c2a3b6-41cf-4808-ba48-1e5581eeea35": "VR2",
                "d9930400-c5c7-4a06-a28d-cc74888426dc": "FREE_GAMES",
                "16b8d09a-d0e3-44e3-96cb-a3b2a21b6d69": "OFFERS",
                "28c9c2b2-cecc-415c-9a08-482a605cb104": "ALL_CONCEPTS",
            },
        };
        await this.createDataPoint(
            `profile_remote_store.selectCategory`,
            common,
            "state",
        ...
        common = {
            ...
            role: "state",
            name: {
                en: "Request PSPlus tier",
                de: "PSPlus Stufe anfordern",
                ru: "Запрос PSPlus",
                pt: "Solicitar PSPlus tier",
                nl: "PSPlus-niveau aanvragen",
                fr: "Demande de niveau PSPlus",
                it: "Richiedi il tier PSPlus",
                es: "Solicitud PSPlus tier",
                pl: "Poziom dokładności PSPlus",
                uk: "Запит PSPlus ярус",
                "zh-cn": "请求 PSPlus 级",
            },
            desc: "Request PSPlus tier",
            read: true,
            write: true,
            def: "TIER_10",
            states: {
        ...
        await this.createDataPoint(`profile_remote_store.featuresRetrieve`, common, "state", "TIER_10", null);
        common = {
            type: "string",
            role: "json",
            name: {
        ...
        common = {
            ...
            role: "state",
            name: {
                en: "Product with product-Id",
                de: "Produkt mit Produkt-Id",
                ru: "Продукт с продуктом",
                pt: "Produto com produto-Id",
                nl: "Product met product-ID",
                fr: "Produit avec produit-Id",
                it: "Prodotto con prodotto-Id",
                es: "Producto con producto-Id",
                pl: "Produkt z product- Id",
                uk: "Продукт з продуктом-Id",
                "zh-cn": "带有产品-Id的产品",
            },
            desc: "Product with product-Id",
            read: true,
            write: true,
            def: "",
        };
        await this.createDataPoint(`profile_remote_store.product_with_productId`, common, "state", "", null);
        common = {
            type: "string",
            role: "state",
            name: {
                en: "Concept with concept-Id",
                de: "Konzept mit Konzept-Id",
                ru: "Концепт с понятием",
                pt: "Conceito com conceito-Id",
                nl: "Concept met concept-Id",
                fr: "Concept avec concept-Id",
                it: "Concetto con concept-Id",
                es: "Concepto con concepto Id",
                pl: "Concept with concept- Id",
                uk: "Концепція концепції",
                "zh-cn": "有概念的概念-Id",
            },
            desc: "Concept with concept-Id",
            read: true,
            write: true,
            def: "0",
        };
        await this.createDataPoint(`profile_remote_store.concept_with_conceptId`, common, "state", "0", null);
        common = {
            type: "string",
            role: "state",
            name: {
                en: "Concept with product-Id",
                de: "Konzept mit Produkt-Id",
                ru: "Концепт с продуктом-Id",
                pt: "Conceito com produto-Id",
                nl: "Concept met product-ID",
                fr: "Concept avec produit-Id",
                it: "Concetto con prodotto-Id",
                es: "Concepto con producto-Id",
                pl: "Koncepcja z product- Id",
                uk: "Концепт з продуктом-Id",
                "zh-cn": "带有产品标识的概念",
            },
            desc: "Concept with product-Id",
            read: true,
            write: true,
            def: "",
        };
        await this.createDataPoint(`profile_remote_store.concept_with_productId`, common, "state", "", null);
        common = {
            type: "string",
            role: "state",
            name: {
                en: "Pricing data with concept-Id",
                de: "Preisdaten mit konzept-Id",
                ru: "Ценовые данные с концептуальной",
                pt: "Pricing dados com conceito-Id",
                nl: "Prijsgegevens met concept-ID",
                fr: "Données de tarification avec concept-Id",
                it: "Prezzi dei dati con concept-Id",
                es: "Datos de precios con concepto-Id",
                pl: "Dane cenowe z konceptem - Id",
                uk: "Ці дані про цінні папки з концепцією",
                "zh-cn": "用概念- Id 定价数据",
            },
            desc: "Pricing data with concept-Id",
            read: true,
            write: true,
            def: "0",
        };
        await this.createDataPoint(`profile_remote_store.pricing_with_conceptId`, common, "state", "0", null);
        common = {
            type: "string",
            role: "state",
            name: {
                en: "Product star rating",
                de: "Produkt Sternebewertung",
                ru: "Рейтинг звезды продукта",
                pt: "Avaliação da estrela do produto",
                nl: "Beoordeling productster",
                fr: "Évaluation des produits",
                it: "Valutazione della stella del prodotto",
                es: "Evaluación de estrellas de producto",
                pl: "Ocena gwiazdki produktu",
                uk: "Рейтинг зірки продукту",
                "zh-cn": "产品明星评级",
            },
            desc: "Product star rating",
            read: true,
            write: true,
            def: "",
        };
        await this.createDataPoint(`profile_remote_store.rating_with_productId`, common, "state", "", null);
        common = {
            type: "string",
            role: "state",
            name: {
                en: "Concept star rating",
                de: "Konzept Sternebewertung",
                ru: "Концептуальный рейтинг",
                pt: "Avaliação da estrela do conceito",
                nl: "Begrippen van sterren",
                fr: "Concept étoile",
                it: "Valutazione della stella di Concept",
                es: "Clasificación de estrellas conceptual",
                pl: "Ocena gwiazdy koncepcyjnej",
                uk: "Рейтинг зірки концепції",
                "zh-cn": "概念星评分",
            },
            desc: "Concept star rating",
            read: true,
            write: true,
            def: "0",
        };
        await this.createDataPoint(`profile_remote_store.rating_with_conceptId`, common, "state", "0", null);
        common = {
            type: "string",
            role: "state",
            name: {
                en: "Addons with title-Id",
                de: "Addons mit Titel-Id",
                ru: "Добавки с заголовком",
                pt: "Addons com título-Id",
                nl: "Met titel-ID",
                fr: "Addons avec titre-Id",
                it: "Addons con titolo-Id",
                es: "Complementos con título-Id",
                pl: "Dodatki z title- Id",
                uk: "Додатки з назвою-Id",
                "zh-cn": "带有标题的添加符- Id",
            },
            desc: "Addons with title-Id",
            read: true,
            write: true,
            def: "",
        };
        await this.createDataPoint(`profile_remote_store.addons_with_titleId`, common, "state", "", null);
        common = {
            type: "boolean",
            role: "button",
            name: {
                en: "Products with parameter (profile_remote_store.param)",
                de: "Produkte mit Parameter (profile_remote_store.param)",
                ru: "Продукты с параметром (profile_remote_store.param)",
                pt: "Produtos com parâmetro (profile_remote_store.param)",
                nl: "Producten met parameter (profile_remote_store.param)",
                fr: "Produits avec paramètre (profile_remote_store.param)",
                it: "Prodotti con parametro (profile_remote_store.param)",
                es: "Productos con parámetro (profile_remote_store.param)",
                pl: "Produkty z parametrem (profile _ remote _ store.param)",
                uk: "Продукція з параметром (profile_remote_store.param)",
                "zh-cn": "带有参数的产品( profile_remote_store.param)",
            },
            desc: "Products with parameter (profile_remote_store.param)",
            read: true,
            write: true,
            def: false,
        };
        await this.createDataPoint(`profile_remote_store.products`, common, "state", false, null);
    },
    /**
    ...
    async createStar() {
        ...
        await this.createDataPoint(`profile_remote_stars`, common, "channel", null, null);
        common = {
            type: "boolean",
            role: "button",
            name: {
                en: "Campaigns which are available",
                de: "Kampagnen, die verfügbar sind",
                ru: "Кампании, которые доступны",
                pt: "Campanhas disponíveis",
                nl: "Beschikbare campagnes",
                fr: "Campagnes disponibles",
                it: "Campagne disponibili",
                es: "Campañas disponibles",
                pl: "Dostępne kampanie",
                uk: "Кампанії, доступні",
                "zh-cn": "现有的运动",
            },
            desc: "Campaigns which are available",
            read: true,
            write: true,
            def: false,
        };
        await this.createDataPoint(`profile_remote_stars.campaigns`, common, "state", false, null);
        common = {
            type: "string",
            role: "state",
            name: {
                en: "Campaigns details with campaign-id",
                de: "Kampagnen-Details mit Kampagnen-ID",
                ru: "Детали кампаний с кампанией",
                pt: "Detalhes de campanhas com campanha-id",
                nl: "Campagnes details met campagne-id",
                fr: "Détails des campagnes avec campagne-id",
                it: "Dettagli campagna con campagna-id",
                es: "Detalles de campañas con identificación de campaña",
                pl: "Kampania szczegóły z kampanii-id",
                uk: "Деталі акції з походом",
                "zh-cn": "运动详情与运动编号",
            },
            desc: "Campaigns details with campaign-id",
            read: true,
            write: true,
            def: "",
        };
        await this.createDataPoint(`profile_remote_stars.campaigns_detail`, common, "state", "", null);
        common = {
            type: "boolean",
            role: "button",
            name: {
                en: "Rewards which are available",
                de: "Rewards, die verfügbar sind",
                ru: "Возмещение, которое доступно",
                pt: "Recompensas disponíveis",
                nl: "Beloningen die beschikbaar zijn",
                fr: "Primes disponibles",
                it: "Ricompense disponibili",
                es: "Recompensas disponibles",
                pl: "Nagrody, które są dostępne",
                uk: "Нагороди, які доступні",
                "zh-cn": "可获得的奖励",
            },
            desc: "Rewards which are available",
            read: true,
            write: true,
            def: false,
        };
        await this.createDataPoint(`profile_remote_stars.rewards`, common, "state", false, null);
        common = {
            type: "string",
            role: "state",
            name: {
                en: "Rewards details with reward-Id",
                de: "Belohnungen-Details mit reward-Id",
                ru: "Награды с reward-Id",
                pt: "Recompensa detalhes com reward-Id",
                nl: "Beloning details met reward-Id",
                fr: "Détails de récompense avec reward-Id",
                it: "Ricompensa i dettagli con reward-Id",
                es: "Detalles de recompensas con recompensa Id",
                pl: "Dane o nagrodach reward-Id",
                uk: "Відновлює деталі з reward-Id",
                "zh-cn": "奖励细节和报酬 编号",
            },
            desc: "Rewards details with reward-Id",
            read: true,
            write: true,
            def: "",
        };
        await this.createDataPoint(`profile_remote_stars.rewards_detail`, common, "state", "", null);
        common = {
            type: "string",
            role: "state",
            name: {
                en: "Details of a specific collectible with collectible-Id",
                de: "Einzelheiten eines bestimmten Sammlers mit Sammler-Id",
                ru: "Подробные сведения о конкретной коллекционной с коллекционной",
                pt: "Detalhes de um colecionável específico com colecionável-Id",
                nl: "Gegevens van een specifieke collectible met collectible-Id",
                fr: "Détails d'une collection spécifique avec collectible-Id",
                it: "Dettagli di un raccoglibile specifico con collezionabile-Id",
                es: "Details of a specific collectible with collectible-Id",
                pl: "Szczegóły określonego kolekcjonerskiego z kolektywa- Id",
                uk: "Деталі конкретного зібраного з колекціонованим",
                "zh-cn": "具体收集文件的细节",
            },
            desc: "Details of a specific collectible with collectible-Id",
            read: true,
            write: true,
            def: "",
        };
        await this.createDataPoint(`profile_remote_stars.collectible_detail`, common, "state", "", null);
        common = {
            type: "boolean",
            role: "button",
            name: {
                en: "Available display cases (or scenes)",
                de: "Verfügbare Vitrinen (oder Szenen)",
                ru: "Доступные случаи отображения (или сцены)",
                pt: "Casos de exibição disponíveis (ou cenas)",
                nl: "Beschikbare vitrines (of scènes)",
                fr: "Boîtes d'affichage (ou scènes) disponibles",
                it: "Case di visualizzazione disponibili (o scene)",
                es: "Casos de visualización disponibles (o escenas)",
                pl: "Dostępne gabloty (lub sceny)",
                uk: "Доступні випадки відображення (або сцени)",
                "zh-cn": "可用的显示例( 或场景)",
            },
            desc: "Available display cases (or scenes)",
            read: true,
            write: true,
            def: false,
        };
        await this.createDataPoint(`profile_remote_stars.display_cases`, common, "state", false, null);
        common = {
            type: "boolean",
            role: "button",
            name: {
                en: "Status Levels or PlayStation Stars Level",
                de: "Statusstufen oder PlayStation Stars Level",
                ru: "Уровень состояния или уровень PlayStation Stars",
                pt: "Nível de status ou nível de PlayStation Stars",
                nl: "Statusniveaus of PlayStation Stars Level",
                fr: "Niveau d'état ou niveau des étoiles PlayStation",
                it: "Livelli di stato o livello PlayStation Stars",
                es: "Niveles de estado o nivel de PlayStation Stars",
                pl: "Poziom stanu lub poziom gwiazd PlayStation",
                uk: "Рівень стану або рівень зірки PlayStation",
                "zh-cn": "状态级别或 PlayStation Stars 级别",
            },
            desc: "Status Levels or PlayStation Stars Level",
            read: true,
            write: true,
            def: false,
        };
        await this.createDataPoint(`profile_remote_stars.rewards_tiers`, common, "state", false, null);
        common = {
            type: "boolean",
            role: "button",
            name: {
                en: "Summary of a users PlayStation Stars profile",
                de: "Zusammenfassung eines Benutzers PlayStation Stars Profil",
                ru: "Оригинальное название: PlayStation Stars profile",
                pt: "Resumo de um perfil de usuários PlayStation Stars",
                nl: "Samenvatting van een gebruikersprofiel van PlayStation Stars",
                fr: "Résumé d'un profil des utilisateurs PlayStation Stars",
                it: "Riepilogo del profilo di PlayStation Stars",
                es: "Resumen de un perfil de usuarios de PlayStation Stars",
                pl: "Podsumowanie profilu użytkowników PlayStation Stars",
                uk: "Резюме користувачів профілю PlayStation Stars",
                "zh-cn": "用户 PlayStation Stars 简介摘要",
            },
            desc: "Summary of a users PlayStation Stars profile",
            read: true,
            write: true,
            def: false,
        };
        await this.createDataPoint(`profile_remote_stars.user_summary`, common, "state", false, null);
        common = {
            type: "boolean",
            role: "button",
            name: {
                en: "Summary of the reward points which a user has earned from service",
                de: "Zusammenfassung der Belohnungspunkte, die ein Benutzer vom Dienst verdient hat",
                ru: "Резюме очков вознаграждения, которые пользователь заработал от обслуживания",
                pt: "Resumo dos pontos de recompensa que um usuário ganhou do serviço",
                nl: "Samenvatting van de beloningspunten die een gebruiker uit de dienst heeft verdiend",
                fr: "Résumé des points de récompense qu'un utilisateur a gagnés du service",
                it: "Riassunto dei punti di ricompensa che un utente ha guadagnato dal servizio",
                es: "Resumen de los puntos de recompensa que un usuario ha ganado desde el servicio",
                pl: "Podsumowanie punktów nagrody, które użytkownik uzyskał z usługi",
                uk: "Резюме пунктів винагороди, які користувач отримав від сервісу",
                "zh-cn": "用户从服务中获得的奖励点摘要",
            },
            desc: "Summary of the reward points which a user has earned from service",
            read: true,
            write: true,
            def: false,
        };
        await this.createDataPoint(`profile_remote_stars.user_history`, common, "state", false, null);
        common = {
            type: "boolean",
            role: "button",
            name: {
                en: "Users collectibles",
                de: "Nutzer Sammlerstücke",
                ru: "Пользователей",
                pt: "Usuários colecionáveis",
                nl: "Gebruikers collectibles",
                fr: "Utilisateurs collectables",
                it: "Collezionismo degli utenti",
                es: "Los usuarios recopilables",
                pl: "Pliki kolekcjonerskie użytkowników",
                uk: "Користувачі, зібрані",
                "zh-cn": "用户收藏",
            },
            desc: "Users collectibles",
            read: true,
            write: true,
            def: false,
        };
        await this.createDataPoint(`profile_remote_stars.user_display_case`, common, "state", false, null);
        common = {
            type: "boolean",
            role: "button",
            name: {
                en: "User earned collectibles",
                de: "Benutzer verdient Sammlerstücke",
                ru: "Заработанные сборные",
                pt: "Colecionáveis ganhos pelo usuário",
                nl: "Gebruiker verdiende collectibles",
                fr: "Collecteurs gagnés par l'utilisateur",
                it: "Acquisizione di oggetti da collezione",
                es: "El usuario ganó coleccionables",
                pl: "Uzyskane przez użytkownika kolekcje",
                uk: "Користувач заробив зібрання",
                "zh-cn": "用户挣得的收藏",
            },
            desc: "User earned collectibles",
            read: true,
            write: true,
            def: false,
        };
        await this.createDataPoint(`profile_remote_stars.user_earned_collectibles`, common, "state", false, null);
        common = {
            type: "string",
            role: "state",
            name: {
        ...
        await this.createDataPoint(`profile_remote_stars.result`, common, "state", "", null);
    },
    /**

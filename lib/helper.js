module.exports = {
    ...
    async createProfile() {
        ...
        await this.createDataPoint(`profile_remote.trophies_game_help_available_for_title`, common, "state", "", null);
        common = {
            type: "string",
            role: "json",
            name: {
        ...
        await this.createDataPoint(
            `profile_remote.trophies_game_help_for_title`,
            common,
            "state",
        ...
        await this.createDataPoint(`profile_remote.search_user`, common, "state", "", null);
        common = {
            type: "string",
            role: "state",
            name: {
        ...
        await this.createDataPoint(`profile_remote.search_game`, common, "state", "", null);
        common = {
            type: "string",
            role: "state",
            name: {
        ...
        await this.createDataPoint(`profile_remote.search_result`, common, "state", "", null);
        common = {
            type: "string",
            role: "state",
            name: {
        ...
        await this.createDataPoint(`profile_remote.search_result_pagination`, common, "state", "", null);
        common = {
            type: "boolean",
            role: "button",
            name: {
        ...
        await this.createDataPoint(`profile_remote.received_requests_without_name`, common, "state", null, null);
        common = {
            type: "boolean",
            role: "button",
            name: {
        ...
        await this.createDataPoint(`profile_remote.received_requests_with_name`, common, "state", null, null);
        common = {
            type: "boolean",
            role: "button",
            name: {

...
module.exports = {
    ...
    async trophiesEarnedTitle(val, constants) {
        ...
        const trophies = await this.requestPSN(methode, url, this.getHeader, params, true);
    ...
    async trophyTitleUserGroup(val, constants) {
        ...
        const trophy_title_group_user = await this.requestPSN(methode, url, this.getHeader, params, true);
    ...
    async trophyTitle(accountId, constants) {
        ...
        const trophy_title = await this.requestPSN(methode, url, this.getHeader, null, true);
    ...
    async loadTrophy_id(val, constants) {
        ...
        const allAccountsSearchResults = await this.requestPSN(methode, url, this.getHeader, params, true);
        ...
        if (
            ...
            this.getHeader.headers["Content-Type"] = "application/x-www-form-urlencoded";
            const methode = "get";
            const trophyTitles = await this.requestPSN(methode, url, this.getHeader, null, true);
            ...
            if (trophyTitles.data && trophyTitles.data.trophyTitles) {
                for (const title of trophyTitles.data.trophyTitles) {
                    ...
                    const titleTrophies = await this.requestPSN(methode, url, this.getHeader, params, true);
                    url =
                        constants.BASE_PATH.trophies +
                        constants.API_PATH.trophies_earned_for_title
                            ...
                            .replace("{np_communication_id}", title.npCommunicationId)
                            .replace("{trophy_group_id}", "all");
                    const earnedTrophies = await this.requestPSN(methode, url, this.getHeader, params, true);
                    if (
                        titleTrophies.data &&
